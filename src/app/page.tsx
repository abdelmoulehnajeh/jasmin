            ...
            <div className="flex items-center justify-between px-4 sm:px-6 md:px-10 lg:px-16 py-3 sm:py-4 md:py-5">
              ...
              <div className="flex items-center gap-2 sm:gap-4 md:gap-5 lg:gap-6">
                ...
                <a
                  ...
                  className="group relative flex items-center gap-1.5 sm:gap-2 text-[#FFC800] sm:text-white hover:text-[#FFC800] transition-all duration-300 transform hover:scale-105 px-2 sm:px-3 py-1.5 sm:py-2 bg-[#FFC800]/10 sm:bg-transparent rounded-lg sm:rounded-none"
                  title="Call Us"
                >
                  <svg className="relative w-4 h-4 sm:w-6 sm:h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56a.977.977 0 00-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z" />
                  </svg>
                  <span className="relative text-[8px] sm:text-xs md:text-sm font-bold uppercase tracking-wider whitespace-nowrap">{t('callUsNow')}</span>
                </a>
                ...
                <a
                  ...
                  className="group relative text-[#1877F2] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 p-1 sm:p-1.5 md:p-2"
                  title="Facebook"
                >
                  ...
                  <svg className="relative w-4 h-4 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative text-[#E4405F] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 p-1 sm:p-1.5 md:p-2"
                  title="Instagram"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative text-[#25D366] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 p-1 sm:p-1.5 md:p-2"
                  title="WhatsApp"
                >
                ...
                {/* Profile Icon with Divider */}
                <div className="flex items-center gap-1.5 sm:gap-3 md:gap-4 ml-1 sm:ml-2 md:ml-3">
                  <div className="h-6 sm:h-6 md:h-8 w-[1px] bg-gradient-to-b from-transparent via-white/30 to-transparent"></div>
                  <a
                    href="/login"
                    className="group relative text-white hover:text-[#FFC800] transition-all duration-300 transform hover:scale-110 p-1 sm:p-1.5"
                    title={t('signIn')}
                  >
                    ...
                    <svg className="relative w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
